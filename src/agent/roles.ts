...
export const ROLE_REGISTRY: Record<Role, RoleConfig> = {
  explore: {
    systemPrompt: [
      ...
      'After each tool call, you MUST output a brief text summary of what you found',
      'before making the next tool call. Do not chain tool calls silently.',
      'When finished, return a concise factual summary',
